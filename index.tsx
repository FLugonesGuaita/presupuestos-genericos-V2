...
import { PDFDocument, StandardFonts, rgb, LineCapStyle, LineJoinStyle } from "https://esm.sh/pdf-lib@1.17.1";
...
const BrushIcon = () => h(Icon, { path: "M15.207 3.793a1 1 0 0 1 0 1.414L8.5 12h-3a1 1 0 0 1-1-1v-3l6.793-6.793a1 1 0 0 1 1.414 0ZM11.5 15a2.5 2.5 0 0 0-2.5 2.5h5A2.5 2.5 0 0 0 11.5 15Z" }); // Simple brush-like approximation
...
// Extracted Control Panel Component
const ControlPanel = ({ 
    pdfDoc, 
    pdfFile, 
    numPages, 
